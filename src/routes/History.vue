...
const { data, isValidating } = useCollection<TotalWeightPerDayViewEntry>('TotalWeightPerDayView', {
    sort: '-date',
    expand: 'day'
})
...
<template>
    <Page>
        <div class="flex justify-between text-accent">
            ...
            <span v-if="isValidating" class="loading loading-bars loading-xs"></span>
        </div>
